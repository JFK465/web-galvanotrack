          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="max-w-3xl">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl">
                Die digitale Lösung für Zink-Nickel Beschichtungen. Dokumentieren Sie alle
                Prozessparameter und erfüllen Sie Automotive-Anforderungen.
              </p>
        ...
        <section className="py-24 bg-zinc-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mt-2 mb-4">Zink-Nickel Anwendungen</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              {[
                { title: "Automotive", description: "Karosserieteile, Fahrwerk, Motorraum." },
                { title: "Nutzfahrzeuge", description: "LKW, Anhänger, Nutzfahrzeugteile." },
                { title: "Offshore", description: "Meerestechnik, Windkraftanlagen." },
                { title: "Bauindustrie", description: "Befestigungsmaterial, Stahlbau." },
                { title: "Elektroindustrie", description: "Schaltschränke, Verteiler." },
                { title: "Möbelindustrie", description: "Beschläge, Gestelle." }
              ].map((item, index) => (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { icon: Shield, title: "IATF 16949", description: "Automotive-Compliance." },
                { icon: Users, title: "Mitarbeiter-Tracking", description: "Wer hat was bearbeitet?" },
                { icon: Building2, title: "Audit-Exporte", description: "Mit einem Klick alle Berichte." }
              ].map((feature, index) => (
                <Card key={index} className="card-metallic h-full hover:border-primary/50 transition-colors">
                  <CardHeader>
